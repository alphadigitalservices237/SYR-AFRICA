        ...
        <section ref={achievementsRef} className="flex justify-center z-10  relative h-auto py-16  lg:py-28 mt-28 lg:mt-56   items-center w-full overflow-hidden">
            ...
            <div className="w-full relative z-10 flex  max-w-[1450px] gap-8 lg:gap-23 px-4 xl:px-44 m-0 p-0 justify-between items-start flex-col lg:flex-row">
                ...
                <div className='w-full lg:w-1/3'>
                    ...
                    <img src={"./st josue/1.jpg"} className='object-cover h-[500px] lg:h-[518px] w-full' />

                </div>
                <div className='w-full lg:w-2/3 flex flex-col gap-6 lg:gap-10  h-auto justify-start items-start'>

                    <span className="border-l-2  border-primary text-black gap-2 pl-3 font-bold">{t("achievements")}</span>
                    <div className='flex flex-col gap-y-4 w-full '>
                        <h2 className="text-xl lg:text-3xl font-bold text-balance">{t("achievementsTitle")}</h2>
                        <p className="text-sm lg:text-xl text-gray-light text-balance">{t("achievementsDesc1")}</p>
                        <p className="text-sm lg:text-xl text-gray-light text-balance">{t("achievementsDesc2")}</p>
                    ...
                    <div className='grid grid-cols-3 w-full gap-6 lg:gap-0'>
                        ...
                        <div className='flex flex-col justify-start gap-3 items-start'>
                            ...
                            <span className='text-gray-light   text-sm md:text-base lg:text-lg text-balance'>{t("yearsExpertise")}</span>
