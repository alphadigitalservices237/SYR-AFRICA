...
const Services = () => {
    ...
    return (
        <section ref={servicesRef} className="flex justify-center z-10 bg-black relative h-auto lg:h-[650px] lg:mt-28 pt-10 lg:pt-28   items-center w-full ">
            <div className="w-full flex max-w-[1450px] px-0 md:px-4 xl:px-44 m-0 p-0 justify-between items-center ">
                <div className="w-full flex flex-col gap-8 lg:gap-12 justify-between items-start">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center w-full gap-4 lg:gap-0">
                        <h3 className="text-2xl lg:text-3xl text-white max-w-xl font-bold">{t("servicesSubtitle")}</h3>
                    ...
                    <div className="flex w-full gap-0 md:gap-4  lg:gap-6 h-[350px] lg:h-[400px]  overflow-hidden">
                        <div className="flex gap-2 md:gap-4 lg:gap-6 transition-transform duration-300" style={{ transform: `translateX(-${currentPage * (100 / 3)}%)` }}>
                            ...
                            >
                                ...
                                <div className="relative z-10 flex p-4 lg:p-8 w-full text-balance justify-end flex-col text-white h-full gap-2 lg:gap-4 items-start">
                                    ...
                                    <p className="text-[#C8C8C8] max-w-xs text-sm lg:text-base pr-4">
