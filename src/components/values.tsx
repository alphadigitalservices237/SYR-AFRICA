...
const Values = () => {
    const values = [
        {
            ...
            description: "Striving for perfection in every structure we build."
        },
        {
            icon: <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            description: "Ensuring accuracy and attention to detail at every stage."
        },
        {
            icon: <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            description: "Delivering projects that meet the highest standards."
        },
        {
            ...
            description: "Integrating creativity and modern solutions into construction."
        },
        {
            icon: <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            description: "Building structures that last and inspire trust."
        }
    ];
    ...
    return (
        <div className='w-full flex flex-col gap-1  justify-start items-center py-15  bg-white/90 min-h-screen relative'>
            ...
            <img  src="/project2.jpg" className="absolute top-0 left-0 w-full h-full object-cover opacity-10 z-0" />
            ...
            <div className="w-full flex max-w-[1450px] px-4 xl:px-44 gap-8 m-0 p-0 justify-between items-start lg:items-center flex-col lg:flex-row">
                <span className="border-l-2  border-primary text-black gap-2 pl-3 font-bold"> Vision </span>
            </div>
            ...
            <div className='w-full flex flex-col justify-start lg:justify-center py-4 items-start lg:items-center'>
                ...
                <h2 className='text-left  px-4 lg:px-0 lg:text-center font-bold  w-full text-2xl lg:text-3xl'>Excellence in Every Structure</h2>
                ...
                <div className='w-full flex flex-col px-4 lg:px-0  lg:flex-row py-11  gap-5 justify-center items-center'>
                    ...
                    <div className="w-full lg:w-1/2 h-full ">
                            <img src="/project2.jpg" className="h-full w-full object-cover" />
                    </div>
